...
Epochs on the x-axis, loss (MSE) on the y-axis; two lines show training loss and validation loss. This illustrates convergence and early stopping (model trained with early stopping on validation loss).
