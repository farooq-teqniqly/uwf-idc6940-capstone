...
The ARIMA(1,1,4) model produces a 14-day point forecast with 80\% and 95\% prediction intervals. Excerpts of the forecast table (dates, point forecast, Lo/Hi 80 and 95) and the forecast plot are included here. [Insert forecast table and figure from the ARIMA pipeline run.]
