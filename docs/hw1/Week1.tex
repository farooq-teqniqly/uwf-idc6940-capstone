...
\newcommand{\name}{\textbf{Student Name (print)}: \underline{\hspace{2in} Farooq Mahmud}  }
\usepackage{listings}
...
\includegraphics[scale=1]{docs/hw1/images/intro.png}
...
\textbf{Join the course Discord channel.} 
 ...
 \includegraphics[scale=1]{docs/hw1/images/discord.png}
...
Uber wait time prediction using the datasets published by the NYC Taxi and Limousine Commission. I would like to predict the wait times using time-series methods and machine learning models and compare their performance.
...
\href{https://docs.google.com/document/d/1PAWyJc56pf78WBtep3CvAGaMZZjem8gUJfEB1aeCQ7A/edit?usp=sharing}{https://docs.google.com/document/d/1PAWyJc56pf78WBtep3CvAGaMZZjem8gUJfEB1aeCQ7A/edit?usp=sharing}
  ...
  \includegraphics[scale=1]{docs/hw1/images/idea.png}
