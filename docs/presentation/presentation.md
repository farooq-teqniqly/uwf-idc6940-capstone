...
![w:600px Full-year daily average Uber trip duration, 2024](../../images/fullyear_ts.png)
...
- MASE < 1 -> beats naive (uses last known value) baseline &nbsp;|&nbsp; MASE > 1 -> worse than naive
...
and accurate enough for outlier detection."
-->
...
![w:600px ARIMA 14-day forecast with 80% and 95% prediction intervals](../../images/arima_intervals.png)
...
![w:400px 14-day forecast comparison: Actual vs ARIMA vs LSTM](../../images/comparison_plot.png)
...
![w:600px LSTM training and validation loss by epoch](../../images/LSTM_loss.png)
...
multiple runs to get stable metrics."
-->
...
[github.com/farooq-teqniqly/uwf-idc6940-capstone-files](https://github.com/farooq-teqniqly/uwf-idc6940-capstone-files/releases/tag/capstone-v1.1)
