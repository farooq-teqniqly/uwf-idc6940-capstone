...
\section{Full-Year Time Series Plot Code}\label{appendix:fullyear_ts_plot}
...
\section{14-Day Comparison Plot Code}\label{appendix:comparison_plot}
...
\section{ARIMA 14-Day Forecast with Intervals Code}\label{appendix:arima_intervals_plot}
