...
Table~\ref{tab:compare} summarizes sMAPE (\%) and MASE for both methods over the same 14-day period. Figure~\ref{fig:comparison_plot} shows the 14-day actual and forecast series for both models.

\begin{figure}[H]
  \centering
  \textbf{[Placeholder: insert comparison plot from \texttt{images/comparison\_plot.png}]}
