...
Figure~\ref{fig:fullyear_ts} shows the full-year time series of daily average trip duration. The code that produces this plot is given in Listing~\ref{lst:fullyear_ts_plot}.

\begin{figure}[H]
  \centering
  \textbf{[Placeholder: insert full-year time series plot]}
...
Table~\ref{tab:compare} summarizes sMAPE (\%) and MASE for both methods over the same 14-day period.
