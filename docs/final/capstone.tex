...
\begin{enumerate}
  \item \textbf{Refine LSTM hyperparameters.} Optionally explore sequence length, number of units, dropout, and training epochs and document the choices in the final report.
  \item \textbf{Extend data if available.} If additional years of NYC TLC data become accessible, extend the daily series to improve LSTM training and reassess both methods.
\end{enumerate}
